@ST_627 @Feature_organisationChart @ST_681042290
Feature: Organisation tree

@SC_3434 @High @dragAndDrop @dragAndDrop_001 @SC_607861301
...
@SC_3435 @High @dragAndDrop @dragAndDrop_002 @SC_676226807
