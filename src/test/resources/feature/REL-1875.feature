@ST_9158 @tagtagtag @this_is_story_tag @new_changes
...
@SC_38496 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_38497 @third_scenario_tag
...
@SC_38498 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_38499 @fifth_scenario_tag
